...
import { ChevronLeft, Save, Plus, X, UserPlus, Home, Phone, Users } from 'lucide-react';
    ...
    try {
      await apiPost('/patients', {
        ...
        familyMembers: familyMembers
          ...
          .map((fm) => ({ ...fm, dob: fm.dob || undefined })),
      });
    ...
    <div style={{ maxWidth: 800, margin: '0 auto' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 12, marginBottom: 40, marginTop: 24 }}>
          <Link href="/patients" className="button secondary">Cancel</Link>
          <button type="submit" className="button" disabled={loading} style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <Save size={18} />
